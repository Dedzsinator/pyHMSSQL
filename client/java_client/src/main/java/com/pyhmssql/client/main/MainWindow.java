...
public class MainWindow extends BorderPane {
    ...
    private void openQueryFile() { /* Implementation */ }
    private void saveCurrentQuery() { /* Implementation */ }
    private void showImportDataDialog() { /* Implementation */ }
    private void showExportDataDialog() { /* Implementation */ }
    private void formatCurrentQuery() { /* Implementation */ }
    private void showFindReplaceDialog() { /* Implementation */ }
    private void explainCurrentQuery() { /* Implementation */ }
    private void showQueryHistoryDialog() { /* Implementation */ }
    private void openQueryBuilder() { /* Implementation */ }
    private void openIndexViewer() { /* Implementation */ }
    private void openTransactionManager() { /* Implementation */ }
    private void showServerStatusDialog() { /* Implementation */ }
    private void showBackupRestoreDialog() { /* Implementation */ }
    private void showThemeCustomizationDialog() { /* Implementation */ }
    private void openPreferencesDialog() { /* Implementation */ }
    private void showCreateDatabaseDialog() { /* Implementation */ }
    private void showDropDatabaseDialog() { /* Implementation */ }
    private void showDatabasePropertiesDialog() { /* Implementation */ }
    private void showAboutDialog() { /* Implementation */ }
    private void showSqlReferenceDialog() { /* Implementation */ }
    private void showKeyboardShortcutsDialog() { /* Implementation */ }
}