...
public class QueryBuilderController {
    ...
    public QueryBuilderController(ConnectionManager connectionManager) {
        ...
        // Initialize sub-controllers without parameters
        this.projectionController = new ProjectionController();
        this.joinController = new JoinController();
        // Fix line 36 - use no-argument constructor
        tableDiagramController = new TableDiagramController();
    }
    ...
    public void removeTable(String tableName) {
        ...
        projectionController.removeColumnsForTable(tableName);

        // Remove all conditions referencing this table
        queryModel.getWhereConditions().removeIf(condition -> condition.getTable().equals(tableName));

        // Remove all joins involving this table
        queryModel.getJoins()
                .removeIf(join -> join.getLeftTable().equals(tableName) || join.getRightTable().equals(tableName));
    }
