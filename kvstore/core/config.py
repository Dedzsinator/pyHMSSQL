...
class HyperKVServerConfig(BaseHyperKVConfig):
    ...
    placement_strategy: str = (
        "NUMA_AWARE"  # NUMA_AWARE, LOAD_BALANCED, LOCALITY_AWARE, ROUND_ROBIN
    )
    ...
    def __post_init__(self):
        ...
        self.worker_threads = int(
            os.getenv("HYPERKV_WORKER_THREADS", self.worker_threads)
        )
        self.enable_profiling = (
            os.getenv("HYPERKV_ENABLE_PROFILING", "false").lower() == "true"
        )
