...
class TestTemporaryTableManager(unittest.TestCase):
    ...
    def test_execute_create_temporary_table_success(self):
        ...
        result = self.temp_table_manager.execute_create_temporary_table(
            plan, session_id
        )
    ...
    def test_execute_create_temporary_table_already_exists(self):
        ...
        result1 = self.temp_table_manager.execute_create_temporary_table(
            plan, session_id
        )
        self.assertEqual(result1["status"], "success")

        # Try to create it again - should fail
        result2 = self.temp_table_manager.execute_create_temporary_table(
            plan, session_id
        )
    ...
    def test_execute_drop_temporary_table_success(self):
        ...
        # Create the table
        create_result = self.temp_table_manager.execute_create_temporary_table(
            create_plan, session_id
        )
        self.assertEqual(create_result["status"], "success")

        # Now drop it
        drop_plan = {"type": "DROP_TEMPORARY_TABLE", "table": "temp_users"}

        # Setup mocks for drop
        self.mock_catalog.drop_table.return_value = True

        drop_result = self.temp_table_manager.execute_drop_temporary_table(
            drop_plan, session_id
        )
    ...
    def test_execute_drop_temporary_table_not_exists(self):
        ...
        drop_plan = {"type": "DROP_TEMPORARY_TABLE", "table": "nonexistent_table"}
        ...
        result = self.temp_table_manager.execute_drop_temporary_table(
            drop_plan, session_id
        )
    ...
    def test_execute_drop_temporary_table_missing_name(self):
        ...
        drop_plan = {"type": "DROP_TEMPORARY_TABLE"}
    ...
    def test_execute_temporary_table_operation_create(self):
        ...
        result = self.temp_table_manager.execute_temporary_table_operation(
            plan, session_id
        )
    ...
    def test_execute_temporary_table_operation_drop(self):
        ...
        create_result = self.temp_table_manager.execute_temporary_table_operation(
            create_plan, session_id
        )
        self.assertEqual(create_result["status"], "success")
        ...
        drop_result = self.temp_table_manager.execute_temporary_table_operation(
            drop_plan, session_id
        )
