...
class TestFunctionManager:
    ...
    def setup_test_environment(self):
        ...
        catalog_manager.create_table("employees", [
        ...
        # Insert test data
        catalog_manager.insert_record("employees", {"id": 1, "name": "John", "salary": 50000, "department": "IT"})
        catalog_manager.insert_record("employees", {"id": 2, "name": "Jane", "salary": 60000, "department": "HR"})
        catalog_manager.insert_record("employees", {"id": 3, "name": "Bob", "salary": 55000, "department": "IT"})
