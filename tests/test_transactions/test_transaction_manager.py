...
class TestTransactionOperations:
    ...
    def test_basic_transaction(
        self, transaction_manager, catalog_manager, execution_engine, test_table
    ):
        """Test basic transaction with commit."""
        # Start transaction
        begin_plan = {"type": "BEGIN_TRANSACTION"}
        begin_result = transaction_manager.execute_transaction_operation(
            "BEGIN_TRANSACTION"
        )
        ...
        # Commit transaction
        commit_result = transaction_manager.execute_transaction_operation(
    ...
    def test_transaction_rollback(
        ...
        rollback_result = transaction_manager.execute_transaction_operation(
