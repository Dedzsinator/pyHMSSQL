...
class TestRestApiPerformanceSimulation:
    ...
    def test_response_time_simulation(self):
        ...
        # Test slow query
        slow_response = client.execute_query(
            "SELECT * FROM large_table", simulate_delay=0.05
        )
    ...
    def test_throughput_simulation(self):
        ...
        class ThroughputMockClient:
            ...
            def execute_query(self, sql):
                ...
                current_throughput = (
                    self.query_count / elapsed_time if elapsed_time > 0 else 0
                )
            ...
            def get_statistics(self):
                ...
                return {
                    ...
                    "average_throughput": (
                        self.query_count / total_time if total_time > 0 else 0
                    ),
                }
...
class TestRestApiIntegrationSimulation:
    ...
    def test_full_workflow_simulation(self):
        ...
        # 2. Create table
        ddl_response = client.execute_ddl(
        ...
        # 5. Update data
        update_response = client.execute_query(
