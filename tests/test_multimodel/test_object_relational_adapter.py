...
class TestObjectRelationalAdapter:
    ...
    def test_create_composite_type(self, adapter):
        ...
        type_definition = {
            ...
            "attributes": [
                ...
                {"name": "country", "type": "varchar(50)", "nullable": False, "default": "USA"}
            ]
        }
    ...
    def test_create_nested_composite_type(self, adapter):
        ...
        address_attrs = [attr for attr in person_type.attributes if attr.type_name == "address"]
...
class TestObjectRelationalPerformance:
    ...
    def test_complex_type_creation_performance(self, adapter):
        ...
        created_types = [name for name in type_names if name.startswith("complex_type_")]
    ...
    def test_nested_validation_performance(self, adapter):
        ...
        for depth in range(1, 6):  # 5 levels of nesting
            nested_def = {
                "type": "composite",
                "attributes": [
                    {"name": "data", "type": f"nested_type_{depth-1}" if depth > 1 else "base_type", "nullable": False},
    ...
    def test_inheritance_resolution_performance(self, adapter):
        ...
        for level in range(10):  # 10 levels deep
            table_def = {
                ...
                "columns": [
                    {"name": f"level_{level}_field", "type": "varchar(100)", "nullable": True}
                ]
            }
            adapter.execute_query(table_def)
...
class TestObjectRelationalEdgeCases:
    ...
    def test_circular_type_dependencies(self, adapter):
        ...
        type_a_def = {
            "type": "composite",
            "attributes": [
                {"name": "b_field", "type": "type_b", "nullable": True}
            ]
        }
        ...
        type_b_def = {
            "type": "composite",
            "attributes": [
                {"name": "a_field", "type": "type_a", "nullable": True}
            ]
        }
    ...
    def test_unicode_and_special_characters_in_types(self, adapter):
        ...
        unicode_type_def = {
            ...
            "attributes": [
                ...
                {"name": "emoji_field", "type": "varchar(50)", "nullable": True, "default": "😀🌟"}
            ]
        }
