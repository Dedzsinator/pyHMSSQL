...
from kvstore.networking import NetworkServer, RESPProtocol, RESPType, ClientConnection
from kvstore.pubsub import PubSubManager, Message, Subscription, Channel
...
class TestRESPProtocol:
    ...
    def test_encode_error(self):
        ...
        result = RESPProtocol.encode_error(
...
class TestSubscription:
    ...
    def test_subscription_creation(self):
        ...
        subscription = Subscription(pattern="test_*", callback=callback)
    ...
    def test_subscription_with_queue(self):
        ...
        subscription = Subscription(pattern="test_*", queue=queue)
...
class TestPubSubPerformance:
    ...
    async def test_pattern_matching_performance(self):
        ...
        assert (
            len(received_messages["product_*"]) == 2
