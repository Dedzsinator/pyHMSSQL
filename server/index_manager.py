...
class IndexManager:
    ...
    def delete_index(self, index_name):
        ...
        if os.path.exists(index_file):
            ...
            tree = self.get_index(index_name)
            if tree:
                tree.visualize(self.visualizer, f"{
                               index_name}_before_deletion")
    ...
    def visualize_all_indexes(self):
        ...
        index_files = [f for f in os.listdir(
            self.index_dir) if f.endswith(".idx")]
    ...
    def build_index(
        self, table_name, index_name, column_name, is_unique=False, db_name=None
    ):
        """
        ...
        logging.info(f"Building index: {index_name} on {
