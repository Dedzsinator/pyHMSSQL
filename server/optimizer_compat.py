...
class LegacyOptimizer:
    ...
    def __init__(self, catalog_manager, index_manager):
        ...
        logging.info(
            "Legacy optimizer initialized with unified backend"
    ...
    def optimize(self, plan, plan_type=None):
        ...
        warnings.warn(
            "Using legacy optimizer fallback - limited optimization capabilities",
            DeprecationWarning,
        )
    ...
    def get_optimization_stats(self):
        ...
        if self.unified_optimizer:
            ...
            return {
                "total_optimizations": stats.get(
                    "total_optimizations", self.optimization_count
                ),
                "total_time_ms": stats.get(
