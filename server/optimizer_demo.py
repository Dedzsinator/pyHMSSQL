...
def main():
    ...
    for level in OptimizationLevel:
        ...
        for query in test_queries:
            ...
            result = optimizer.optimize(query['plan'], f"demo_{query['name'].replace(' ', '_')}")
            end_time = time.time()
            ...
            print(f"  {query['name']}: {optimization_time:.2f}ms, "
    ...
    try:
        ...
        print(f"Estimated improvement: {result.estimated_cost / complex_plan['estimated_cost']:.2f}x")
    ...
    print(f"Memory Usage: {final_stats['plan_cache']['memory_usage_bytes'] / 1024:.1f} KB")
